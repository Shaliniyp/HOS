...
<body>
	...
	<div id="templatemo_container">
		...
		<div id="templatemo_content_bar">
			<div class="templatemo_product_box">
				<h1 align="center">VIEW BILL (COOK)</h1>
			</div>
		</div>
		<div id="templatemo_content">
			...
			<div id="templatemo_content_right">
				<form action="ViewBillToCook.jsp" method="post">
					<table
						style="width: 90%; margin: 10px; padding: 10px; border-style: double">
						<tr>
							<td>tableNo</td>
				...
				%>
					...
					<form action="cook?action=clear" method="post">
						<table width="100%">
							...
							%>
							<tr>
								<td><input type="submit" value="CLEAR" name="cl" /></td>
							</tr>
						</table>
					</form>
				...
				%>
				There is no Bill Details available on this table No
